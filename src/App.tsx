...
const BRAND = {
  name: "Fabian's Air",
  fullName: "Fabian's Air HVAC",
  phone: '714-450-5734',
  email: 'service@fabiansairhvac.com',
  address: 'Anaheim, CA',
  location: 'Anaheim, CA',
...
const locations = [
  {
    id: 'anaheim',
    name: 'Anaheim',
    heroTitle: 'Serving Anaheim With Excellence',
    description: `We are proud to serve Anaheim, bringing top-tier HVAC services to businesses and residents in the heart of Orange County. As a hub of innovation and family life, Anaheim recognizes the value of excellence, and we are committed to delivering tailored solutions that meet the high standards of this community. From the busy commercial centers to the pristine residential neighborhoods, our technicians ensure your environment remains perfectly climate-controlled year-round. We understand the specific architectural styles and environmental factors that influence heating and cooling efficiency in Anaheim, allowing us to provide preventative maintenance and rapid repairs that keep your systems running at peak performance while minimizing energy costs. Whether you need a complex installation for a new office space or a delicate repair for your home's air quality system, we bring the expertise and reliability that Anaheim deserves.`,
    mapImage: '/locations/anaheim.png'
  },
  {
    id: 'irvine',
    name: 'Irvine',
    ...
    <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-8">
      ...
      <div className="col-span-2 md:col-span-3 lg:col-span-1">
        <div className="flex items-center gap-3 text-white mb-6">
          <div className="w-10 h-10 bg-primary rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg">FA</div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            { title: 'Community Care', desc: 'Serving our neighbors in Anaheim isn\'t just business; it\'s personal. We treat your home with the same respect as our own.' }
          ].map((val, i) => (
            <motion.div
              key={i}
              whileHover={{ y: -10 }}
